...
void function InitSinglePlayerMenu()
{
	...
	AddMenuFooterOption( menu, BUTTON_Y, "%[Y_BUTTON|]% Practice Warps", "Practice Warps", SRMM_OpenPracticeWarpsMenu)
}

void function SRMM_OpenPracticeWarpsMenu(var button)
{
	AdvanceMenu( GetMenu( "SRMM_PracticeWarpsMenu" ) )
}
